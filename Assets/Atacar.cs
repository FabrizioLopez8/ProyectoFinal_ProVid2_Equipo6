// Accion de ataque: calcula el da�o con multiplicador de tipo y lo aplica al objetivo
// using UnityEngine;
...
//     {
//         // Si el objetivo tiene escudo activo, lo consume y no recibe da�o
...
//         // Calcula el da�o final redondeado al entero mas cercano
//         int danio = Mathf.RoundToInt(atacante.criatura.ataque * multi);

//         // Aplica el da�o sin que el HP baje de 0
