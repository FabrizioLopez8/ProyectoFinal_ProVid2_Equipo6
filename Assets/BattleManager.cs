...
//     // Calcula el multiplicador de da�o segun el tipo del atacante y el defensor
...
//         // Desventajas (da�o reducido a la mitad)
...
//             MostrarDialogo($"{atacante.nombre} atac� a {objetivo.nombre}");
//         else
